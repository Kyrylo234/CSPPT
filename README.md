...
Tab area: Offers the main features of the program such as File, Home, Insert, Animations, and Presentation.
...
Insert: Allows inserting images, videos, and audio, creating new CS charts, shapes, tables, math charts, text boxes, and code sections.
Animation: Offers animations for slide transitions during presentations.
Presentation: You have three options to start the slideshow: From the Beginning, From the Current Slide, and Slide Show with Recording.
...
CS Chart:
		...
		Double-click the border of one CS BOX and then click the border of another CS BOX, the system will pop up a dialogue box for you to choose the type of connector line. 		
...
Presentation hints:
		...
		You can use the Record Button which stays in the Presentation Bar to start the slideshow. It will record the frame changes. When you end the presentation, it will be a dialog that let you save the recorded video file.
