...
public class RealizationLine extends BaseLine{
    ...
    //creates the line for realization
    public RealizationLine(Point point1, Point point2, ClassDiagram connectDiagram, ClassDiagram mainDiagram, int x, int y, int width, int height, MouseHandler listener, JLayeredPane frame1, String type, CSPPTFile file , int layer, boolean flipped, int slideNumber,String lineType){
    ...
    //creates line for realization when opening a file
    public RealizationLine(CSLine line, MouseHandler listener, JLayeredPane frame, CSPPTFile file, int slideNum, boolean isOpeningFile) {
