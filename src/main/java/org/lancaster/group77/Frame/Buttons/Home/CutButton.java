...
public class CutButton extends IconButton {
    ...
    public CutButton(ImageIcon imageIcon, int x, int y, int width, int height, String inputButtonRole, MouseHandler handler) {
    ...
    public static void cut(){
        ...
        if (handler.getLastClickSlide() != -1) {
            ...
            GlobalVariables.cspptFrame.removeSlide(handler.getLastClickSlide());
            ...
            selectedObjects.add(selectedObject);
            clipboardInterface.copy(selectedObjects);
            GlobalVariables.cspptFrame.removeComponent(displayComponent, GlobalVariables.cspptFrame.getPane());
